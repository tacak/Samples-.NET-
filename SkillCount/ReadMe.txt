================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : SkillCount プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した SkillCount には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには SkillCount アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
SkillCount.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CSkillCountApp アプリケーション クラス
    の宣言をします。

SkillCount.cpp
    このファイルは CSkillCountApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\SkillCount.ico
    ...
    リソース ファイル SkillCount.rc によってインクルードされます。
...
SkillCountDlg.h, SkillCountDlg.cpp - the dialog
    Tこれらのファイルは CSkillCountDlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な SkillCount.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) SkillCount.pch や既にコン 
